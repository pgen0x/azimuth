...
MAX_OOR_MINUTES = 30
# Turnover fast-cycle (Reference-bot-style): an OOR turnover position is idle
    ...
    for pos_addr in active_positions:
        ...
        if close_reason:
            ...
            if close_res and close_res.get("success"):
                ...
                # OOR rebalance (Reference-bot-style re-center): a position drifting
                ...
                # Reference-bot's low-yield pool cooldown): the symbol cooldown above
