...
* **skill:** bid_ask bin shapes + Reference-bot-style turnover OOR rebalance ([6c2a2e3](https://github.com/pgen0x/meteora-dlmm-trading-bot/commit/6c2a2e35b65d8d2faabd88a63946401e6fb0ea9b))
...
- Layered risk gates: TVL, fee/TVL, market cap, holder count, organic score,
  ...
  status, and a best-effort DexScreener downtrend filter (Reference-bot
